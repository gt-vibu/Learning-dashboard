...
export default function MobileNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-white border-t border-[#e2ddd6] flex items-center justify-around px-2 py-2">
      {items.map((item) => {
          ...
          >
            {isActive && (
              <motion.div
                ...
                className="absolute inset-0 rounded-lg bg-[#4f46e5]/8"
